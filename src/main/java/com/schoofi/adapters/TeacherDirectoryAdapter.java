...
public class TeacherDirectoryAdapter extends BaseAdapter {
    private Context context;
    private JSONArray teacherDirectoryArray;
    private ColorGenerator mColorGenerator = ColorGenerator.MATERIAL;
    private TextDrawable.IBuilder mDrawableBuilder;

    public TeacherDirectoryAdapter(Context context, JSONArray teacherDirectoryArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInflater.inflate(R.layout.teacher_directory_listview_layout, null);
