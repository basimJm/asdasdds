...
/**
 * Created by Schoofi on 02-03-2017.
 */

public class TeacherNewMultilevelAdapter extends BaseExpandableListAdapter {
    ...
    public TeacherNewMultilevelAdapter(Context context, ArrayList<DiaryVO> diaryVOs) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder1.iconAttachment2 = (ImageView) convertView.findViewById(R.id.icon_type);
        ...
        if(assignmentMultiLevelVO.getType().matches("Circular"))
        {
              holder1.subjectName.setVisibility(View.GONE);
        }
        else {
            if (assignmentMultiLevelVO.getOptionalSubject().matches("") || assignmentMultiLevelVO.getOptionalSubject().matches("null")) {
                holder1.subjectName.setVisibility(View.VISIBLE);
        ...
        holder1.teacherName.setVisibility(View.GONE);
    ...
    static class Holder
    {
        ...
        private ImageView iconAttachment,iconAttachment2;
