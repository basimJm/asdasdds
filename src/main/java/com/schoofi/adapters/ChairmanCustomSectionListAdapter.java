...
public class ChairmanCustomSectionListAdapter extends BaseAdapter{
	private Context context;
	private JSONArray chairmanSection1ListArray;

	public ChairmanCustomSectionListAdapter(Context context, JSONArray chairmanSection1ListArray) {
		super();
