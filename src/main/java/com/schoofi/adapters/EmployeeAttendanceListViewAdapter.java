...
public class EmployeeAttendanceListViewAdapter extends BaseAdapter {
    ...
    public EmployeeAttendanceListViewAdapter(Context context,JSONArray employeeAttendanceArray) {
        ...
        else
        {
            ...
            try {
                ...
                if (employeeAttendanceArray.getJSONObject(position).getString("attendance").equals("P")) {
                    ...
                    holder.attendance.setColorFilter(ContextCompat.getColor(context, R.color.green));
                    ...
                    holder.attendance.setColorFilter(ContextCompat.getColor(context, R.color.red));
