...
public class ChairmanStudentWeeklyClassListAdapter extends BaseAdapter{

	private Context context;
	private JSONArray chairmanClass1ListArray;

	public ChairmanStudentWeeklyClassListAdapter(Context context, JSONArray chairmanClass1ListArray) {
		super();
