...
public class ChairmanDiscountClassWiseFeesAdapter extends BaseAdapter {
    ...
    public ChairmanDiscountClassWiseFeesAdapter(Context context, JSONArray ChairmanStudentFragmentFeesClassArray) {
