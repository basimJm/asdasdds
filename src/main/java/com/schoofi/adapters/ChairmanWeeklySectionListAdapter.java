...
public class ChairmanWeeklySectionListAdapter extends BaseAdapter{
	
	private Context context;
	private JSONArray chairmanSection1ListArray;

	public ChairmanWeeklySectionListAdapter(Context context, JSONArray chairmanSection1ListArray) {
		super();
