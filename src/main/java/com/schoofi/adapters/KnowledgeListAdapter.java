...
public class KnowledgeListAdapter extends BaseAdapter {
    ...
    public KnowledgeListAdapter(Context context, JSONArray knowledgeResourseSubjectArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            {
                holder.taskName.setText(knowledgeResourseSubjectArray.getJSONObject(position).getString("title"));
                holder.className.setVisibility(View.GONE);
            }

            else {
                holder.taskName.setText(knowledgeResourseSubjectArray.getJSONObject(position).getString("title"));
                holder.className.setText(knowledgeResourseSubjectArray.getJSONObject(position).getString("subject"));
            }
