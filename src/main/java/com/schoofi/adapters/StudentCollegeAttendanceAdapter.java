...
public class StudentCollegeAttendanceAdapter extends BaseAdapter {
    ...
    public StudentCollegeAttendanceAdapter(Context context,JSONArray studentDailyAttendanceArray)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {   holder = new Holder();
            ...
            convertView = layoutInflater.inflate(R.layout.student_college_daily_attendance_layout, null);
            ...
            holder.periodNo =(TextView) convertView.findViewById(R.id.text_student_daily_period_number);
            //Log.d("hhh", "harsh"+567);
        ...
        try {
            ...
            holder.periodNo.setText(studentDailyAttendanceArray.getJSONObject(position).getString("period_no"));
    ...
    static class Holder
    {
        TextView studentDailyAttendanceDate,periodNo;
