...
public class AdminEmployeeLeaveListAdapter extends BaseAdapter{
    ...
    public AdminEmployeeLeaveListAdapter(Context context,JSONArray teacherStudentLeaveListArray) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            holder.employeeType = (TextView) convertView.findViewById(R.id.text_employee_type);
        ...
        try {
            ...
            holder.employeeType.setText(teacherStudentLeaveListArray.getJSONObject(position).getString(""));
    ...
    static class Holder
    {
        TextView studentName,leaveSubject,fromDate,toDate ,employeeType;
