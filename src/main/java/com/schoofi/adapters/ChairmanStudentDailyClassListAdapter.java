...
public class ChairmanStudentDailyClassListAdapter extends BaseAdapter{

	private Context context;
	private JSONArray chairmanClass1ListArray;

	public ChairmanStudentDailyClassListAdapter(Context context, JSONArray chairmanClass1ListArray) {
		super();
