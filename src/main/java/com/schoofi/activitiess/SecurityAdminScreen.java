...
public class SecurityAdminScreen extends AppCompatActivity {
    GridView studentHomeScreenGridView;
    ImageView settings;
    int []studentHomeScreenIcon = {R.drawable.visitor,R.drawable.announcement,R.drawable.events};
    int []studentHomeScreenIcon1 = {R.drawable.visitortablet,R.drawable.announcementtablet,R.drawable.eventstablet};
    String []studentHomeScreenIconName = {"Visitor Form","Announcements","Events"};
    int[] COLORS = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SecurityAdminScreen.this,StudentSettings.class);
        ...
        if(u.matches("2"))
        {
            studentHomeScreenGridView.setAdapter(new StudentHomeScreenAdapter(SecurityAdminScreen.this, studentHomeScreenIconFinal,studentHomeScreenIconNamefinal,COLORS));
        }

        else
        {
            studentHomeScreenGridView.setAdapter(new StudentHomeScreenTabletAdapter(SecurityAdminScreen.this, studentHomeScreenIconFinal1,studentHomeScreenIconNamefinal,COLORS));
        ...
        studentHomeScreenGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    ...
                    case 0:
                        Intent intent = new Intent(SecurityAdminScreen.this, SecurityVisitorListScreen.class);
                        intent.putExtra("value","4");
                        startActivity(intent);
                        break;

                    case 1:
                        Intent intent1 = new Intent(SecurityAdminScreen.this, TeacherAnnouncement.class);
                        intent1.putExtra("value","4");
                        startActivity(intent1);
                        break;

                    case 2:
                        Intent intent2 = new Intent(SecurityAdminScreen.this, TeacherEventList.class);
