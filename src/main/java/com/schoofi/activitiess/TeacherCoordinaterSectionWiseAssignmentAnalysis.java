...
public class TeacherCoordinaterSectionWiseAssignmentAnalysis extends DemoBase implements OnChartValueSelectedListener {
    ...
    Date selectedDate3;
    String dat,fromDate,toDate,classId;
    Date date3,date4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_coordinater_section_wise_assignment_analysis);
...
//        mChart.setDrawBorders(true);
        ...
        *//*yVals1.add(new BarEntry(a, 0));
        ...
        colors.add(Color.rgb(238, 71, 73));
        ...
        BarDataSet set1 = new BarDataSet(yVals, "Section Assignments");
...
//        data.setValueFormatter(new LargeValueFormatter());
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Section Assignment Analysis");
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
        ...
        Intent intent = new Intent(TeacherCoordinaterSectionWiseAssignmentAnalysis.this,TeacherCoordinatorAssignmentSubjectWiseAnalysis.class);
        intent.putExtra("position1",e.getXIndex());
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (responseObject.has("Msg") && responseObject.getString("Msg").equals("0")) {
                        ...
                        techerCoordinatorattendanceArrray1= new JSONObject(response).getJSONArray("responseObject").getJSONObject(position).getJSONArray("sections");
                        if(null!=techerCoordinatorattendanceArrray1 && techerCoordinatorattendanceArrray1.length()>=0) {
                            ...
                            int p=0;
                            for(int i=0;i<techerCoordinatorattendanceArrray1.length();i++)
                            {
                                classNames.add(techerCoordinatorattendanceArrray1.getJSONObject(i).getString("section_name"));

                                pendingFees.add(Float.parseFloat(techerCoordinatorattendanceArrray1.getJSONObject(i).getString("total_assignment_sec")));
                                p=p+Integer.parseInt(techerCoordinatorattendanceArrray1.getJSONObject(i).getString("total_assignment_sec"));
                            }

                            Log.d("kjii",pendingFees.toString()+fromDate+toDate);

                            totalPendingfees.setText("Class "+className+" - Total: "+String.valueOf(p));
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        MPPointF position2 = mChart.getPosition(e, YAxis.AxisDependency.LEFT);

        Log.i("bounds", bounds.toString());
        Log.i("position", position2.toString());
        ...
        position1 = e.getX();
        Intent intent = new Intent(TeacherCoordinaterSectionWiseAssignmentAnalysis.this,TeacherCoordinatorAssignmentSubjectWiseAnalysis.class);
        intent.putExtra("position1",(int)(Math.round(position1)));
        intent.putExtra("fromDate",fromDate);
        intent.putExtra("toDate",toDate);
        intent.putExtra("position",position);
        intent.putExtra("class_names",className);
        try {
            intent.putExtra("section_names",techerCoordinatorattendanceArrray1.getJSONObject(Math.round(position1)).getString("section_name"));
