...
public class BusAdminHomeScreen extends AppCompatActivity {

    GridView studentHomeScreenGridView;
    ImageView settings;
    int[] studentHomeScreenIcon = {R.drawable.gps, R.drawable.busattendance, R.drawable.busnotification};
    int[] studentHomeScreenIcon1 = {R.drawable.gpstablet, R.drawable.busattendancetablet, R.drawable.busnotificationtablet};
    String[] studentHomeScreenIconName = {"BUS TRACKING", "BUS ATTENDANCE", "BUS NOTIFICATIONS"};
    int[] COLORS = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("Bus Admin Home Screen");
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BusAdminHomeScreen.this, StudentSettings.class);
        ...
        Preferences.getInstance().loadPreference(BusAdminHomeScreen.this);
        ...
        for(int h =0;h<permissionsArray.size();h++)
        {
            ...
            if (u.matches("2")) {
                studentHomeScreenGridView.setAdapter(new StudentHomeScreenAdapter(BusAdminHomeScreen.this, studentHomeScreenIconFinal, studentHomeScreenIconNamefinal, COLORS));
            } else {
                studentHomeScreenGridView.setAdapter(new StudentHomeScreenTabletAdapter(BusAdminHomeScreen.this, studentHomeScreenIconFinal1, studentHomeScreenIconNamefinal, COLORS));
                ...
                switch (position) {
                    case 0:
                        if(studentHomeScreenIconNamefinal.get(0).matches("BUS TRACKING")) {
                            Intent intent = new Intent(BusAdminHomeScreen.this,BusAdminBusList.class);
                        ...
                        {
                            Intent intent6 = new Intent(BusAdminHomeScreen.this, TeacherStudentBusAttendancePrimaryScreen.class);
                            ...
                            {
                                Intent intent2 = new Intent(BusAdminHomeScreen.this, BusAdminBusList.class);
                    ...
                    case 1:
                        if(studentHomeScreenIconNamefinal.get(1).matches("BUS TRACKING")) {
                            Intent intent = new Intent(BusAdminHomeScreen.this, AdminBusListScreen.class);
                            intent.putExtra("value","1");
                            startActivity(intent);
