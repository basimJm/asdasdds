...
public class HRHomeScreen extends AppCompatActivity {
    ...
    String []studentHomeScreenIconName= {"ANNOUNCEMENTS/NOTICES","ATTENDANCE","LEAVE REQUEST","BUS ATTENDANCE","BUS NOTIFICATIONS","FEEDBACK","YEARLY PLANNER","EVENTS","POLLS" ,"EMPLOYEE DIRECTORY","EMPLOYEE ATTENDANCE"};
    int []studentHomeScreenIcon = {R.drawable.announcement,R.drawable.attendence,R.drawable.leaverequest,R.drawable.busattendance,R.drawable.busnotification,R.drawable.feedback,R.drawable.yearlyplanner,R.drawable.events,R.drawable.poll,R.drawable.teacherdirectory};
    int []studentHomeScreenIcon1= {R.drawable.announcementtablet,R.drawable.attendancetablet,R.drawable.leaverequesttablet,R.drawable.busattendancetablet,R.drawable.busnotificationtablet,R.drawable.feedbacktablet,R.drawable.yearlyplannertablet,R.drawable.eventstablet,R.drawable.polltablet,R.drawable.teacherdirectorytablet};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HRHomeScreen.this,StudentSettings.class);
        ...
        if(u.matches("2"))
        {
            studentHomeScreenGridView.setAdapter(new StudentHomeScreenAdapter(HRHomeScreen.this, studentHomeScreenIconFinal,studentHomeScreenIconNamefinal,COLORS));
        }

        else
        {
            studentHomeScreenGridView.setAdapter(new StudentHomeScreenTabletAdapter(HRHomeScreen.this, studentHomeScreenIconFinal1,studentHomeScreenIconNamefinal,COLORS));
        ...
        studentHomeScreenGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    ...
                    case 0:
                        Intent intent6 = new Intent(HRHomeScreen.this,TeacherAnnouncement.class);
                    ...
                    case 1:
                        ...
                        Intent intent = new Intent(HRHomeScreen.this,AdminAttendanceFirtsScreen.class);
                        startActivity(intent);
                        break;

                    case 2:
                        Intent intent2 = new Intent(HRHomeScreen.this,TeacherLeaveNewPrimaryScreen.class);
                    ...
                    case 3:
                        Intent intent9 = new Intent(HRHomeScreen.this,TeacherStudentBusAttendancePrimaryScreen.class);
                        //intent5.putExtra("value3","0");
                    ...
                    case 4:
                        Intent intent11 = new Intent(HRHomeScreen.this, BusAdminBusList.class);
                        intent11.putExtra("value","2");
                        startActivity(intent11);
                        break;

                    case 5:
                        Intent intent27 = new Intent(HRHomeScreen.this, TeacherStudentFeedback.class);

                        startActivity(intent27);
                        break;

                    case 6:
                        Intent intent10 = new Intent(HRHomeScreen.this,SchoolPlannerMakingFirstScreen.class);
                        //intent5.putExtra("value3","0");
                        startActivity(intent10);
                        break;

                    case 7:
                        Intent intent22 = new Intent(HRHomeScreen.this,TeacherEventList.class);
                    ...
                    case 8:
                        ...
                        Intent intent5 = new Intent(HRHomeScreen.this,NewPollActivity.class);
                        intent5.putExtra("value3","0");
                    ...
                    case 9:
                        ...
                        Intent intent17 = new Intent(HRHomeScreen.this,AdminEmployeeList.class);
                        intent17.putExtra("value3","0");
