...
public class TeacherDirectory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.activity_teacher_directory);
        ...
        teacherDirectoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                   ...
                   Intent intent = new Intent(TeacherDirectory.this,ChairmanTeacherProfile.class);
    ...
    private void initData()
    {
        ...
        {
            teacherDirectoryAdapter= new TeacherDirectoryAdapter(TeacherDirectory.this,teacherDirectoryArray);
            teacherDirectoryListView.setAdapter(teacherDirectoryAdapter);
