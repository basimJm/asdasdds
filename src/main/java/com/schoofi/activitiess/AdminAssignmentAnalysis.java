...
public class AdminAssignmentAnalysis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.activity_admin_assignment_analysis);
        ...
        viewAnalysis2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AdminAssignmentAnalysis.this,ChairmanAssignmentAnalysisDetailScreen.class);
