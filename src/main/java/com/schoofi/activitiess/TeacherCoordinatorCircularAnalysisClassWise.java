...
public class TeacherCoordinatorCircularAnalysisClassWise extends DemoBase implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_coordinator_circular_analysis_class_wise);
