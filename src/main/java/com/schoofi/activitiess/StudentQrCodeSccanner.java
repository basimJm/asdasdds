...
public class StudentQrCodeSccanner extends Activity implements ZBarScannerView.ResultHandler{
    ...
    public void handleResult(Result rawResult) {
        ...
        Intent intent = new Intent(StudentQrCodeSccanner.this,AdminStudentDropForm.class);
