...
public class StudyPlannerClassListScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Preferences.getInstance().loadPreference(StudyPlannerClassListScreen.this);
        ...
        notify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StudyPlannerClassListScreen.this,AttendanceNotifyScreen.class);
        ...
        teacherStudentAttendanceListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                try {
                    ...
                    Preferences.getInstance().savePreference(StudyPlannerClassListScreen.this);
                } catch (JSONException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }

                Intent intent = new Intent(StudyPlannerClassListScreen.this,SchoolPlannerSubjectList.class);
    ...
    private void initData()
    {
        ...
        {
            teacherStudentAttendanceAdapter= new TeacherStudentAttendanceAdapter(StudyPlannerClassListScreen.this,teacherStudentAttendanceArray);
    ...
    protected void getTeacherClassList()
    {
        ...
        RequestQueue queue = VolleySingleton.getInstance(StudyPlannerClassListScreen.this).getRequestQueue();
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if(responseObject.has("error")&&responseObject.getString("error").equals("0"))
                    {
                        teacherStudentAttendanceListView.setVisibility(View.INVISIBLE);
                        newView1.setVisibility(View.INVISIBLE);
                        Utils.showToast(StudyPlannerClassListScreen.this, "Session Expired:Please Login Again");
                    }
                    else
...

                    {
                        ...
                        Utils.showToast(StudyPlannerClassListScreen.this, "Error Fetching Response");
                ...
                {
                    e.printStackTrace();
                    Utils.showToast(StudyPlannerClassListScreen.this, "Error fetching modules! Please try after sometime.");
                    setSupportProgressBarIndeterminateVisibility(false);
                }
        ...
        if(Utils.isNetworkAvailable(StudyPlannerClassListScreen.this))
            queue.add(requestObject);
        else
        {
            Utils.showToast(StudyPlannerClassListScreen.this, "Unable to fetch data, kindly enable internet settings!");
        }
    }
    private void toa()
    {
