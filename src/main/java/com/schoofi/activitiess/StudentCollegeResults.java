...
public class StudentCollegeResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.activity_student_college_results);

        Preferences.getInstance().loadPreference(StudentCollegeResults.this);
       ...
       // listView1 = new ListView(getApplicationContext());
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent intent = new Intent(StudentCollegeResults.this,StudentResultPart2COScholasticAreas1.class);
        ...
        studentResultListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(termId.matches("OT"))
                {
                    ...
                    try {
                        Intent intent = new Intent(StudentCollegeResults.this,StudentResultDetails.class);
    ...
    private void initData3()
    {
        ...
        if(termArray!= null)
        {
            termAdapter= new TermAdapter(StudentCollegeResults.this,termArray);
    ...
    protected void getChairmanExamClassList()
    {
        ...
        RequestQueue queue = VolleySingleton.getInstance(StudentCollegeResults.this).getRequestQueue();
        ...
        StringRequest requestObject = new StringRequest(Request.Method.POST,url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    {
                        Utils.showToast(StudentCollegeResults.this,"No Records Found");
                    ...
                    {
                        Utils.showToast(StudentCollegeResults.this, "Session Expired:Please Login Again");
                    }
                    else
    ...
    private void initData4()
    {
        ...
        {
            studentResultSpinnerAdapter= new StudentResultSpinnerAdapter(StudentCollegeResults.this,studentResultSpinnerArray);
            ...
            try {
                if (studentResultArray.getJSONObject(0).getString("display_option").matches("G")) {
                   // subjectMarks.setVisibility(View.INVISIBLE);
                    ...
                    studentResultListAdapter = new StudentResultListAdapter(StudentCollegeResults.this, studentResultArray);
    ...
    protected void getStudentResultList()
    {
        ...
        RequestQueue queue = VolleySingleton.getInstance(StudentCollegeResults.this).getRequestQueue();
        final String url = AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.STUDENT_RESULT_EXAM_LIST_COLLEGE+"?sec_id="+Preferences.getInstance().studentSectionId+"&sch_id="+Preferences.getInstance().schoolId+"&cls_id="+Preferences.getInstance().studentClassId+"&stu_id="+Preferences.getInstance().studentId+"&ex_id="+resultExamId1+"&u_email_id="+Preferences.getInstance().userEmailId+"&u_id="+Preferences.getInstance().userId+"&token="+Preferences.getInstance().token+"&device_id="+Preferences.getInstance().deviceId+"&session="+Preferences.getInstance().session1+"&ins_id="+Preferences.getInstance().institutionId;
        StringRequest requestObject = new StringRequest(Request.Method.GET,url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if(responseObject.has("Result"))
                    {
                        ...
                        if(null!=studentResultArray && studentResultArray.length()>=0)
                        {
                            ...
                            VolleySingleton.getInstance(StudentCollegeResults.this).getRequestQueue().getCache().put(AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.STUDENT_RESULT_EXAM_LIST_COLLEGE+"?sec_id="+Preferences.getInstance().studentSectionId+"&sch_id="+Preferences.getInstance().schoolId+"&cls_id="+Preferences.getInstance().studentClassId+"&stu_id="+Preferences.getInstance().studentId+"&ex_id="+resultExamId1+"&u_email_id="+Preferences.getInstance().userEmailId+"&u_id="+Preferences.getInstance().userId+"&token="+Preferences.getInstance().token+"&device_id="+Preferences.getInstance().deviceId+"&session="+Preferences.getInstance().session1+"&ins_id="+Preferences.getInstance().institutionId,e);
                        ...
                        Utils.showToast(StudentCollegeResults.this, "Error Fetching Response");
                ...
                {
                    e.printStackTrace();
                    Utils.showToast(StudentCollegeResults.this, "Error fetching modules! Please try after sometime.");
                    setSupportProgressBarIndeterminateVisibility(false);
                }
        ...
        requestObject.setRetryPolicy(new DefaultRetryPolicy(
                ...
                DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        if(Utils.isNetworkAvailable(StudentCollegeResults.this))
            queue.add(requestObject);
        else
        {
            Utils.showToast(StudentCollegeResults.this, "Unable to fetch data, kindly enable internet settings!");
        }
    }
    private void toa()
    {
