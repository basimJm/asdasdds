...
public class ChairmanStudentFees extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("Chairman Student Fees");

        // Send a screen view.
        t.send(new HitBuilders.ScreenViewBuilder().build());
        setContentView(R.layout.activity_chairman_student_fees);
        ...
        drawerListener = new ActionBarDrawerToggle(ChairmanStudentFees.this, drawerlayout, toolbar, R.string.drawer_open, R.string.drawer_close)
        {
            @Override
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            Intent intent = new Intent(ChairmanStudentFees.this,ChairmanDashboard.class);
            ...
            switch(position)
            {
                case 0 :
                    if(homeUserAdapter.partialNameArray1.get(position).matches("SWITCH SCHOOL")) {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanHomeScreen.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanSchoolAttendance.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanStudentResult.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanStudentPoll.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanStudentEvents.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanStudentLeaves.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanStudentAnnouncement.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanStudentFeedBack.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanBusListScreen.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, NotificationIntentClass.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanProfile.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, WebViewActivity.class);
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChangePassword.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ContactUs.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, LoginScreen.class);
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, ChairmanYearlyPlanner.class);
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, HealthAndAuditHomeScreen.class);
                ...
                case 6 :if(homeUserAdapter.partialNameArray1.get(position).matches("SWITCH SCHOOL")) {
                    Intent intent = new Intent(ChairmanStudentFees.this, ChairmanHomeScreen.class);
                    startActivity(intent);
                    finish();
                    break;
        ...
        else
        {
            switch(position)
            {
                ...
                case 16:
                    ...
                    if(homeUserAdapter.partialNameArray1.get(position).matches("ABOUT US"))
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this, AboutUs.class);
                        startActivity(intent);
                        finish();
                        break;
                    }
        ...
        StringRequest requestObject = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    {
                        Intent intent = new Intent(ChairmanStudentFees.this,AboutSchool.class);
                        startActivity(intent);
                    }
