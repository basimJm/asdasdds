...
public class TeacherStudentAttendance extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Preferences.getInstance().loadPreference(TeacherStudentAttendance.this);
		...
		notify.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(TeacherStudentAttendance.this,AttendanceNotifyScreen.class);
		...
		teacherStudentAttendanceListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				try {
					...
					Preferences.getInstance().savePreference(TeacherStudentAttendance.this);
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				
				Intent intent = new Intent(TeacherStudentAttendance.this,TeacherStudentAttendanceDetails.class);
	...
	private void initData() 
	{
		...
		{
			teacherStudentAttendanceAdapter= new TeacherStudentAttendanceAdapter(TeacherStudentAttendance.this,teacherStudentAttendanceArray);
	...
	protected void getTeacherClassList() 
	{
		...
		RequestQueue queue = VolleySingleton.getInstance(TeacherStudentAttendance.this).getRequestQueue();
		...
		StringRequest requestObject = new StringRequest(Request.Method.GET,url, new Response.Listener<String>() {
			...
			public void onResponse(String response) {
				...
				try 
				{
					...
					if(responseObject.has("Msg")&&responseObject.getString("Msg").equals("0"))
					{
						...
						if(responseObject.has("error")&&responseObject.getString("error").equals("0"))
						{
							teacherStudentAttendanceListView.setVisibility(View.INVISIBLE);
							newView1.setVisibility(View.INVISIBLE);
							Utils.showToast(TeacherStudentAttendance.this, "Session Expired:Please Login Again");
						}
						else
								...
								
							{
								...
								Utils.showToast(TeacherStudentAttendance.this, "Error Fetching Response");
				...
				{
					e.printStackTrace();
					Utils.showToast(TeacherStudentAttendance.this, "Error fetching modules! Please try after sometime.");
					setSupportProgressBarIndeterminateVisibility(false);
				}
			...
			})
		{
			...
			if(Utils.isNetworkAvailable(TeacherStudentAttendance.this))
				queue.add(requestObject);
			else
			{
				Utils.showToast(TeacherStudentAttendance.this, "Unable to fetch data, kindly enable internet settings!");
			}
	}	
	private void toa()
	{
