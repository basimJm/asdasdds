...
public class VisitorQrCodeScanner extends Activity implements ZBarScannerView.ResultHandler{
...
public void handleResult(Result rawResult) {
        ...
        Intent intent = new Intent(VisitorQrCodeScanner.this,VisitorMainScreen.class);
