...
public class TeacherSelfLeaveList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.activity_teacher_self_leave_list);
        ...
        studentLeaveList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View convertView, int position,
                ...
                try {
                    Intent intent=new Intent(TeacherSelfLeaveList.this,TeacherSelfLeaveListDetails.class);
        ...
        newLeave.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(TeacherSelfLeaveList.this,TeacherLeaveApplication.class);
                startActivity(intent);
    ...
    private void initData()
    {
        ...
        {
            studentLeaveListAdapter= new TeacherSelfLeaveListAdapter(TeacherSelfLeaveList.this,studentLeaveListArray,"2");
    ...
    protected void getStudentLeaveList()
    {
        ...
        final String url = AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.EMPLOYEE_LEAVE_LIST/*+"?u_email_id="+userEmailId+"&u_id="+userId+"&token="+token+"&student_ID=" +studentId*/;
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if(responseObject.has("Msg")&&responseObject.getString("Msg").equals("0")) {
                        ...
                        studentLeaveList.setVisibility(View.INVISIBLE);
                    }
                    else
                    ...
                    if(responseObject.has("Tech_LeaveList"))
                    {
                        ...
                        if(null!=studentLeaveListArray && studentLeaveListArray.length()>=0)
                        {
                            ...
                            VolleySingleton.getInstance(getApplicationContext()).getRequestQueue().getCache().put(AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.EMPLOYEE_LEAVE_LIST+"?device_id="+Preferences.getInstance().deviceId+"&ins_id="+Preferences.getInstance().institutionId+"&sch_id="+Preferences.getInstance().schoolId+"&token="+Preferences.getInstance().token+"&emp_id="+Preferences.getInstance().employeeId,e);
