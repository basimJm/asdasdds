...
public class TeacherCoordinatorAssignmentSubjectWiseAnalysis extends DemoBase implements OnChartValueSelectedListener {
    ...
    private int year, month, day,position,position1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_coordinator_assignment_subject_wise_analysis);
        ...
        position1 = getIntent().getExtras().getInt("position1");
        className = getIntent().getStringExtra("class_names");
        sectionName = getIntent().getStringExtra("section_names");
...
//        data.setValueFormatter(new LargeValueFormatter());
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Subject Assignment Analysis");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (responseObject.has("Msg") && responseObject.getString("Msg").equals("0")) {
                        ...
                        techerCoordinatorattendanceArrray1= new JSONObject(response).getJSONArray("responseObject").getJSONObject(position).getJSONArray("sections").getJSONObject(position1).getJSONArray("subjects");
                        if(null!=techerCoordinatorattendanceArrray1 && techerCoordinatorattendanceArrray1.length()>=0) {
                            ...
                            {
                                classNames.add(techerCoordinatorattendanceArrray1.getJSONObject(i).getString("subject"));

                                pendingFees.add(Float.parseFloat(techerCoordinatorattendanceArrray1.getJSONObject(i).getString("total_class_assignment")));
                                p=p+Integer.parseInt(techerCoordinatorattendanceArrray1.getJSONObject(i).getString("total_class_assignment"));
                            }

                            Log.d("kjii",pendingFees.toString()+fromDate+toDate);

                            totalPendingfees.setText("Class "+className+"-"+sectionName+" Total: "+String.valueOf(p));
