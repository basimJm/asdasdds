...
public class TeacherCoordinatorCircularAnalysisSectionWise extends DemoBase implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_coordinator_circular_analysis_section_wise);
...
//        data.setValueFormatter(new LargeValueFormatter());
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Section Circular Analysis");
