...
public class FeeAdminScreen extends AppCompatActivity {
    ...
    String[] studentHomeScreenIconName = {"FEES"};
    int[] COLORS = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       buttonGone = (Button) findViewById(R.id.btn_gone);
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FeeAdminScreen.this, StudentSettings.class);
        ...
        Preferences.getInstance().loadPreference(FeeAdminScreen.this);
       ...
       // Utils.showToast(getApplicationContext(),permissionsArray.toString());
        ...
        for(int h =0;h<permissionsArray.size();h++)
        {
            ...
            if (u.matches("2")) {
                studentHomeScreenGridView.setAdapter(new StudentHomeScreenAdapter(FeeAdminScreen.this, studentHomeScreenIconFinal, studentHomeScreenIconNamefinal, COLORS));
            } else {
                studentHomeScreenGridView.setAdapter(new StudentHomeScreenTabletAdapter(FeeAdminScreen.this, studentHomeScreenIconFinal1, studentHomeScreenIconNamefinal, COLORS));
                ...
                switch (position) {
                    case 0:
                        if (studentHomeScreenIconNamefinal.get(0).matches("FEES")) {
                            Intent intent = new Intent(FeeAdminScreen.this, FeeAdminActivity.class);
                            startActivity(intent);
                            break;
                        }
