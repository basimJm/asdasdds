...
public class AdminVisitorTypeDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.activity_admin_visitor_type_details);
        ...
        if(value.matches("3"))
        {
            ...
            to1 = getIntent().getStringExtra("to1");
        }
        ...
        chairmanAssignmentClassSectionWiseAnalysis.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AdminVisitorTypeDetailsActivity.this, AdminVisitorDetailsActivity.class);
