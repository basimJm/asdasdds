...
public class TeacherCoordinatorBusAttendanceAnalysisRouteAnalysis extends DemoBase implements OnChartValueSelectedListener {
    ...
    Date selectedDate3;
    String dat,busNumber;
    Date date3,date4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teacher_coordinator_bus_attendance_analysis_route_analysis);
    ...
    protected void getChairmanStudentLeaveList() {
        ...
        final String url = AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.TEACHER_COORDINATOR_BUS_ATTENDANCE_ANALYSIS_ROUTE_WISE/*+"?u_email_id="+userEmailId+"&u_id="+userId+"&token="+token+"&student_ID=" +studentId*/;
                ...
                try {
                    ...
                    if (responseObject.has("Msg") && responseObject.getString("Msg").equals("0")) {
                        ...
                        if(null!=techerCoordinatorattendanceArrray && techerCoordinatorattendanceArrray.length()>=0) {
                            ...
                            {
                                classNames.add(techerCoordinatorattendanceArrray.getJSONObject(i).getString("route_no"));
    ...
    protected void openChart()
    {
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Bus Route Attendance");
