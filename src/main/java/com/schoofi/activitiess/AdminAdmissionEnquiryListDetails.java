...
public class AdminAdmissionEnquiryListDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.activity_admin_admission_enquiry_list_details);
        ...
        updateStatus = (ImageView) findViewById(R.id.img_status);
        ...
        updateStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Intent intent = new Intent(AdminAdmissionEnquiryListDetails.this,AdminAdmissionUpdateStatus.class);
                    intent.putExtra("req_ref_id",admissionStatusArray.getJSONObject(position).getString("req_ref_id"));
        ...
        try {
            Cache.Entry e;
            e = VolleySingleton.getInstance(AdminAdmissionEnquiryListDetails.this).getRequestQueue().getCache().get(AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.ADMIN_ADMISSION_ENQUIRY_LIST+"?token="+Preferences.getInstance().token+"&sch_id="+Preferences.getInstance().schoolId+"&device_id="+Preferences.getInstance().deviceId);
