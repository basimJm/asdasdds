...
public class BusCoordinatorAdminScreen extends AppCompatActivity {

    GridView studentHomeScreenGridView;
    ImageView settings;
    int []studentHomeScreenIcon = {R.drawable.busboarding,R.drawable.buspickup};
    int []studentHomeScreenIcon1 = {R.drawable.busboardingtablet,R.drawable.buspickuptablet};
    String []studentHomeScreenIconName = {"Student Boarding","Student Pickup"};
    int[] COLORS = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BusCoordinatorAdminScreen.this,StudentSettings.class);
        ...
        if(u.matches("2"))
        {
            studentHomeScreenGridView.setAdapter(new StudentHomeScreenAdapter(BusCoordinatorAdminScreen.this, studentHomeScreenIconFinal,studentHomeScreenIconNamefinal,COLORS));
        }

        else
        {
            studentHomeScreenGridView.setAdapter(new StudentHomeScreenTabletAdapter(BusCoordinatorAdminScreen.this, studentHomeScreenIconFinal1,studentHomeScreenIconNamefinal,COLORS));
        ...
        studentHomeScreenGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    ...
                    case 0:
                        Intent intent = new Intent(BusCoordinatorAdminScreen.this, AdminStudentBusBoardingScreen.class);
                        intent.putExtra("value","0");
                        startActivity(intent);
                        break;

                    case 1:
                        Intent intent1 = new Intent(BusCoordinatorAdminScreen.this, AdminStudentDropForm.class);
