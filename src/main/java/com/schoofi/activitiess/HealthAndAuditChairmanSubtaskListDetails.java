...
public class HealthAndAuditChairmanSubtaskListDetails extends AppCompatActivity {
    ...
    String taskId,uniqueId,array,userId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Cache.Entry e;
            e = VolleySingleton.getInstance(HealthAndAuditChairmanSubtaskListDetails.this).getRequestQueue().getCache().get(AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.HEALTH_AND_AUDIT_USER_SUBTASK_LIST+"?u_id="+userId+"&token="+Preferences.getInstance().token+"&device_id="+Preferences.getInstance().deviceId+"&ins_id="+Preferences.getInstance().institutionId+"&value="+"3"+"&task_id="+taskId+"&unique_id="+uniqueId);
            ...
            try {
                ...
                studentFeedBackImagesGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        {
                            Intent intent = new Intent(HealthAndAuditChairmanSubtaskListDetails.this,TeacherStudentImageDetails.class);
