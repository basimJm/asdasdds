 ...
 */
public class TeacherAllFeedbackDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("Teacher All Feedback Details");
        ...
        if(teacherFeedBackAssignedArray1!= null)
        {
            try {
                ...
                nameDetail1.setText(teacherFeedBackAssignedArray1.getJSONObject(position).getString("Name"));
                typeDetail.setText("Type:");
                typeDetail1.setText(teacherFeedBackAssignedArray1.getJSONObject(position).getString("full_name"));
                date.setText("Date:");
                date2 = teacherFeedBackAssignedArray1.getJSONObject(position).getString("created_date");
                ...
                description1.setText(teacherFeedBackAssignedArray1.getJSONObject(position).getString("description"));
                feedBackId = teacherFeedBackAssignedArray1.getJSONObject(position).getString("feedback_id");
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(TeacherAllFeedbackDetails.this,FragmentsActivity.class);
