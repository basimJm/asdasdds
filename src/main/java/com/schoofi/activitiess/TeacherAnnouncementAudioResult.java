...
public class TeacherAnnouncementAudioResult extends AppCompatActivity{
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if(teacherAnnouncementArray!= null)
		{
			try {
				...
				url = teacherAnnouncementArray.getJSONObject(position).getString("image_path");
			} 
			catch (Exception e) 
			{
				e.printStackTrace();
