...
public class FragmentsActivity extends FragmentActivity {
  ...
  //  ArrayList<String> urt = new ArrayList<String>();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Set screen name.
		t.setScreenName("Fragment Activity");

		// Send a screen view.
		t.send(new HitBuilders.ScreenViewBuilder().build());
		setContentView(R.layout.activity_fragment);
		mContext = FragmentsActivity.this;
		submit = (Button) findViewById(R.id.btn_submit);
		messageReply = (EditText) findViewById(R.id.edit_feedback);
    ...
    protected void postAttendance()
	{
		...
		final ProgressDialog loading = ProgressDialog.show(this, "Uploading...", "Please wait...", false, false);
			final String url1 = AppConstants.SERVER_URLS.SERVER_URL+AppConstants.SERVER_URLS.FEEDBACK_ASSIGN_IMAGES;
			...
			})
		{
			...
			protected Map<String,String> getParams(){
				...
				params.put("u_name", Preferences.getInstance().Name);
