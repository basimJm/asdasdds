...
public class TeacherCoordinaterAssignmentAnalysisHomeScreen extends DemoBase implements View.OnClickListener,OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_coordinater_assignment_analysis_home_screen);
        ...
        assignmentTextView = (TextView) findViewById(R.id.text_assignment);
        ...
        assignmentTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

//                Intent intent = new Intent(TeacherCoordinaterAssignmentAnalysisHomeScreen.this,TeacherCoordinatorAssignementClassWiseAnalysis.class);
//                intent.putExtra("fromDate",date1);
    ...
    private View.OnClickListener onEditTextClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (calendarPopup == null) {
                calendarPopup = new PopupWindow(TeacherCoordinaterAssignmentAnalysisHomeScreen.this);
                CalendarPickerView calendarView = new CalendarPickerView(TeacherCoordinaterAssignmentAnalysisHomeScreen.this);
            ...
            calendarPopup.showAtLocation(assignmentTextView, Gravity.CENTER, 0, 0);
        }
    };
    ...
    private View.OnClickListener onEditTextClickListener1 = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (calendarPopup1 == null) {
                calendarPopup1 = new PopupWindow(TeacherCoordinaterAssignmentAnalysisHomeScreen.this);
                CalendarPickerView calendarView = new CalendarPickerView(TeacherCoordinaterAssignmentAnalysisHomeScreen.this);
            ...
            calendarPopup1.showAtLocation(assignmentTextView, Gravity.CENTER, 0, 0);
        }
    };
...
//        data.setValueFormatter(new LargeValueFormatter());
        ...
        if (mChart.getData() != null &&
            ...
            if(identifier.matches("assignment")) {
            ...
            {
                set1 = new BarDataSet(yVals1, "Class Circular Analysis");
                set1.setDrawIcons(false);
                set1.setColors(Color.rgb(31, 144, 69));
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        position1 = e.getX();
        if(identifier.matches("assignment")) {
            Intent intent = new Intent(TeacherCoordinaterAssignmentAnalysisHomeScreen.this, TeacherCoordinaterSectionWiseAssignmentAnalysis.class);
        ...
        {
            Intent intent = new Intent(TeacherCoordinaterAssignmentAnalysisHomeScreen.this, TeacherCoordinatorCircularAnalysisClassWise.class);
            intent.putExtra("position", (int) (Math.round(position1)));
            intent.putExtra("fromDate", fromDate);
            intent.putExtra("toDate", toDate);
            try {
