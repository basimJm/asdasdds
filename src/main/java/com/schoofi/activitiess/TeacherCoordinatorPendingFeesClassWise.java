...
public class TeacherCoordinatorPendingFeesClassWise extends DemoBase implements OnChartValueSelectedListener {
...
//        mChart.setDrawBorders(true);
       ...
       /* mChart.getAxisRight().setEnabled(true);
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Class Fees Defaulters");
...
/*for(int o=0;o<classNames.size();o++)
{
    ...
    yVals.add(new BarEntry(val, o));
        ...
        BarDataSet set1 = new BarDataSet(yVals, "Class Fee Defaulters");
...
//        data.setValueFormatter(new LargeValueFormatter());
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
        ...
        Intent intent = new Intent(TeacherCoordinatorPendingFeesClassWise.this,TeacherCoordinatorPendingFeesSectionWise.class);
                ...
                try {
                    ...
                    if (responseObject.has("Msg") && responseObject.getString("Msg").equals("0")) {
                        ...
                        if(null!=techerCoordinatorattendanceArrray && techerCoordinatorattendanceArrray.length()>=0) {
                            ...
                            Context context;
                            context = TeacherCoordinatorPendingFeesClassWise.this;
                            ...
                            totalPendingfees.setText("Total Pending Fees: "+Rs+techerCoordinatorattendanceArrray.getJSONObject(0).getString("amount_due"));
                            ...
                            for(int i=0;i<techerCoordinatorattendanceArrray.length();i++)
                            {
                                ...
                                pendingFees.add(Float.parseFloat(techerCoordinatorattendanceArrray.getJSONObject(i).getString("amount_due_cls")));
                            }
    ...
    public void onValueSelected(Entry e, Highlight h) {
       ...
       // position1 = Integer.parseInt(mChart.getXAxis().getValueFormatter().getFormattedValue(e.getX(), mChart.getXAxis()));
        //Log.d("kks", String.valueOf(position1));
        Log.d("kl", String.valueOf(mChart.getXAxis().getPosition()));
        position1 = e.getX();
        Intent intent = new Intent(TeacherCoordinatorPendingFeesClassWise.this,TeacherCoordinatorPendingFeesSectionWise.class);
