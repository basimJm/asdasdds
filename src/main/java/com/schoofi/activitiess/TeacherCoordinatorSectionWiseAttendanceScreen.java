...
public class TeacherCoordinatorSectionWiseAttendanceScreen extends DemoBase implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_coordinator_section_wise_attendance_screen);
    ...
    protected void openChart()
    {
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "Section Wise Attendance");
    ...
    protected void getChairmanStudentLeaveList() {
        ...
        final String url = AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.TEACHER_COORDINATOR_ATTENDANCE_ANALYSIS_SECTION_WISE/*+"?u_email_id="+userEmailId+"&u_id="+userId+"&token="+token+"&student_ID=" +studentId*/;
                ...
                try {
                    ...
                    if (responseObject.has("Msg") && responseObject.getString("Msg").equals("0")) {
                        ...
                        if(null!=techerCoordinatorattendanceArrray && techerCoordinatorattendanceArrray.length()>=0) {
                            ...
                            {
                                classNames.add(techerCoordinatorattendanceArrray.getJSONObject(i).getString("section_names"));
