...
public class TeacherStudentCollegeAttendanceNew extends AppCompatActivity {
    ...
    Date selectedDate3;
    String dat,subject_id,periodId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Preferences.getInstance().loadPreference(TeacherStudentCollegeAttendanceNew.this);
        ...
        horizontalCalendar.setCalendarListener(new HorizontalCalendarListener() {
            ...
            public void onDateSelected(Date date0, int position) {
                ...
                RequestQueue queue = VolleySingleton.getInstance(TeacherStudentCollegeAttendanceNew.this).getRequestQueue();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (responseObject.has("Msg") && responseObject.getString("Msg").equals("0")) {
                                ...
                                Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "No Records Found");
                                ...
                                Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "Session Expired:Please Login Again");
                            }
                            else if (responseObject.has("Msg") && responseObject.getString("Msg").equals("2")) {
                                teacherStudentAttendanceListViewDetails.setVisibility(View.INVISIBLE);
                                Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "Today is Holiday! You can't take the attendance");
                            }
...

                            {
                                ...
                                if (null != teacherStudentAttendanceArray1 && teacherStudentAttendanceArray1.length() >= 0) {
                                    ...
                                    //Log.d("poo",AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.TEACHER_COLLEGE_STUDENT_ATTENDANCE_LIST + "?u_email_id=" + userEmailId + "&u_id=" + userId + "&token=" + token + "&id_class=" + classId + "&id_class_section=" + sectionId + "&sch_id=" + schoolId + "&crr_date="/*+"2003-11-21"*/ + date + "&device_id=" + Preferences.getInstance().deviceId+"&ins_id="+Preferences.getInstance().institutionId+"&subject_id="+subject_id+"&period_number="+periodId);
                                    VolleySingleton.getInstance(TeacherStudentCollegeAttendanceNew.this).getRequestQueue().getCache().put(AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.TEACHER_COLLEGE_STUDENT_ATTENDANCE_LIST + "?u_email_id=" + userEmailId + "&u_id=" + userId + "&token=" + token + "&id_class=" + classId + "&id_class_section=" + sectionId + "&sch_id=" + schoolId + "&crr_date="/*+"2003-11-21"*/ + date + "&device_id=" + Preferences.getInstance().deviceId+"&ins_id="+Preferences.getInstance().institutionId+"&subject_id="+subject_id+"&period_number="+periodId, e);
                                    teacherStudentAttendanceListViewDetails.invalidateViews();
                                    teacherAttendanceDetailsListViewAdapter = new TeacherAttendanceDetailsListViewAdapter(TeacherStudentCollegeAttendanceNew.this, teacherStudentAttendanceArray1, 1);
                                ...
                                Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "Error Fetching Response");
                            setSupportProgressBarIndeterminateVisibility(false);

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "Error fetching modules! Please try after sometime.");
                            setSupportProgressBarIndeterminateVisibility(false);
                        }
                ...
                if (Utils.isNetworkAvailable(TeacherStudentCollegeAttendanceNew.this))
                    queue.add(requestObject);
                else {
                    Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "Unable to fetch data, kindly enable internet settings!");
                }
            }
    ...
    private void initData()
    {
        ...
        {
            Entry e;
            e = VolleySingleton.getInstance(getApplicationContext()).getRequestQueue().getCache().get(AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.TEACHER_COLLEGE_STUDENT_ATTENDANCE_LIST+"?u_email_id="+userEmailId+"&u_id="+userId+"&token="+token+"&id_class="+classId+"&id_class_section="+sectionId+"&sch_id="+schoolId+"&crr_date="/*+"2003-11-21"*/+date+"&device_id="+Preferences.getInstance().deviceId+"&ins_id="+Preferences.getInstance().institutionId+"&subject_id="+subject_id+"&period_number="+periodId);
            if(e == null)
            {
                teacherStudentAttendanceArray1= null;
            }
        ...
        StringRequest requestObject = new StringRequest(Request.Method.POST,url1, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    {
                        loading.dismiss();
                        Utils.showToast(TeacherStudentCollegeAttendanceNew.this,"Error Submitting Comment");
                    ...
                    {
                        loading.dismiss();
                        Utils.showToast(TeacherStudentCollegeAttendanceNew.this,"Successfuly Submitted Attendance");
                        submit.setEnabled(false);
                        submit.setBackgroundResource(R.drawable.button_red_50_percent);
                        getTeacherStudentList2();
                ...
                catch(JSONException e)
                {
                    e.printStackTrace();
                    loading.dismiss();
                    Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "Error submitting alert! Please try after sometime.");
                }
                //setSupportProgressBarIndeterminateVisibility(false);
    ...
    private void initData4()
    {
        ...
        if(teacherStudentAttendanceArray1!= null)
        {
            teacherAttendanceDetailsListViewAdapter= new TeacherAttendanceDetailsListViewAdapter(TeacherStudentCollegeAttendanceNew.this,teacherStudentAttendanceArray1,2);
            teacherStudentAttendanceListViewDetails.setAdapter(teacherAttendanceDetailsListViewAdapter);
            teacherAttendanceDetailsListViewAdapter.notifyDataSetChanged();
        }
    }
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if(responseObject.has("Msg")&&responseObject.getString("Msg").equals("1"))
                    {
                        ...
                        Utils.showToast(TeacherStudentCollegeAttendanceNew.this, "");
                        teacherStudentAttendanceListViewDetails.setVisibility(View.VISIBLE);
                    }
