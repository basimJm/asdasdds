...
public class DiaryImageSharingScreen extends AppCompatActivity {

    String title,rating,description;
    private ImageView logo,back,share,icon,imageview;
    private TextView label,title1,description1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("Diary Image Sharing Screen");
...
// hide the navigation bar.
        ...
        setContentView(R.layout.activity_diary_image_sharing_screen);
        title = getIntent().getStringExtra("title");
        description = getIntent().getStringExtra("description");
        rating = getIntent().getStringExtra("rating");

        imagesArray = getIntent().getStringExtra("images");
        imageview = (ImageView) findViewById(R.id.imageView_schoolLogo1);
        getStudentFeedList();
        ...
        aList = new ArrayList<String>(Arrays.asList(imagesArray.split(",")));

        randomImage = getRandomList(aList);

        Glide.with(DiaryImageSharingScreen.this).load(AppConstants.SERVER_URLS.IMAGE_URL + randomImage).crossFade().placeholder(R.drawable.eventimage).error(R.drawable.eventimage).into(imageview);
        ...
        title1 = (TextView) findViewById(R.id.text_school_title);
        description1 = (TextView) findViewById(R.id.text_view_descrption);
        logo = (ImageView) findViewById(R.id.imageView_schoolLogo);
    ...
    public String getRandomList(ArrayList<String> list) {
                ...
                try
                {
                    ...
                    if(responseObject.has("school"))
                    {
                        ...
                        if(null!=schoolNotificationListArray && schoolNotificationListArray.length()>=0)
                        {
                            ...
                            Glide.with(DiaryImageSharingScreen.this).load(AppConstants.SERVER_URLS.IMAGE_URL+schoolNotificationListArray.getJSONObject(0).getString("school_logo")).crossFade().placeholder(R.drawable.imagenotavailble).error(R.drawable.imagenotavailble).into(logo);
