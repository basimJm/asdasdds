...
import com.schoofi.adapters.ParentFeesViewPagerAdapter;
...
public class ParentFees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new ParentFeesViewPagerAdapter(getSupportFragmentManager()));
