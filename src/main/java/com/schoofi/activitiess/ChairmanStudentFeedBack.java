...
public class ChairmanStudentFeedBack extends AppCompatActivity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chairman_student_feed_back);
		
		Tracker t = ((SchoofiApplication)this.getApplication()).getTracker(TrackerName.APP_TRACKER);

		// Set screen name.
		t.setScreenName("Chairman StudentFeedBack");
		...
		drawerListener = new ActionBarDrawerToggle(ChairmanStudentFeedBack.this, drawerlayout, toolbar, R.string.drawer_open, R.string.drawer_close)
		{
			@Override
	  ...
	  chairmanStudentFeedBackList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				Preferences.getInstance().savePreference(ChairmanStudentFeedBack.this);
				Intent intent = new Intent(ChairmanStudentFeedBack.this,ChairmanStudentFeedBackDetails.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		...
		{
			Intent intent = new Intent(ChairmanStudentFeedBack.this,ChairmanDashboard.class);
			startActivity(intent);
			finish();
		}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		case 0 :
			if(homeUserAdapter.partialNameArray1.get(position).matches("SWITCH SCHOOL")) {
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanHomeScreen.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanSchoolAttendance.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanStudentFees.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanStudentResult.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanStudentPoll.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanStudentEvents.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanStudentLeaves.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanStudentAnnouncement.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanBusListScreen.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, NotificationIntentClass.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanProfile.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, WebViewActivity.class);
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChangePassword.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ContactUs.class);
				startActivity(intent);
				finish();
				break;
			}
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, LoginScreen.class);
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanYearlyPlanner.class);
			...
			{
				Intent intent = new Intent(ChairmanStudentFeedBack.this, HealthAndAuditHomeScreen.class);
		...
		case 4 :if(homeUserAdapter.partialNameArray1.get(position).matches("SWITCH SCHOOL")) {
			Intent intent = new Intent(ChairmanStudentFeedBack.this, ChairmanHomeScreen.class);
			startActivity(intent);
			finish();
			break;
		...
		StringRequest requestObject = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
			...
			public void onResponse(String response) {
				...
				try
				{
					...
					if(responseObject.has("Msg")&&responseObject.getString("Msg").equals("0"))
					{
						Intent intent = new Intent(ChairmanStudentFeedBack.this,AboutSchool.class);
						startActivity(intent);
					}
