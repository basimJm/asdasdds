...
public class TeacherFeedbackDetails extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Set screen name.
		t.setScreenName("Teacher Feedback Details");
		...
		reply.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
				Intent intent = new Intent(TeacherFeedbackDetails.this,FragmentsActivity.class);
