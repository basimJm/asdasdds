...
public class BusAdminShiftScreen extends AppCompatActivity {
    ...
    ImageView back;
    String bus_route,bus_number,value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("Bus Admin Shift Screen");
        ...
        //Utils.showToast(getApplicationContext(),bus_number);
        ...
        healthAndAuditListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(value.matches("1"))
                {
                    Intent intent = new Intent(BusAdminShiftScreen.this,NewBusTracking.class);
                    try {
                    ...
                    Intent intent = new Intent(BusAdminShiftScreen.this, AdminBusNotificationSendingScreen.class);
                    try {
                        intent.putExtra("bus_route", teacherStudentBusListArray.getJSONObject(i).getString("route_no"));
                        intent.putExtra("bus_no", bus_number);
                        startActivity(intent);
    ...
    private void initData()
    {
        ...
        if(teacherStudentBusListArray!= null)
        {
            ...
            busRouteListAdapter = new BusRouteListAdapter(BusAdminShiftScreen.this, teacherStudentBusListArray);
    ...
    protected void getChairmanStudentLeaveList()
    {
        ...
        RequestQueue queue = VolleySingleton.getInstance(BusAdminShiftScreen.this).getRequestQueue();
