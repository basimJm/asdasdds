...
public class EventSharingScreen extends AppCompatActivity {
    ...
    TextView title,date,place,audience,schoolName,schoolAddress;
    String startDate,endDate,value;
    int position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("Event Sharing Screen");
...
// hide the navigation bar.
        ...
        setContentView(R.layout.activity_event_sharing_screen);
        ...
        schoolLogo = (ImageView) findViewById(R.id.imageView_school_logo);
        //schoofiLogo = (ImageView) findViewById(R.id.background_image);
        ...
        title = (TextView) findViewById(R.id.text_school_title);
        date = (TextView) findViewById(R.id.text_school_date);
        place = (TextView) findViewById(R.id.text_school_description);
        audience = (TextView) findViewById(R.id.text_school_group);
        ...
        linearLayout = (LinearLayout) findViewById(R.id.linear_above);
        value = getIntent().getStringExtra("value");
        Typeface face = Typeface.createFromAsset(getAssets(), "fonts/RobotoCondensed-Bold.ttf");
        title.setTypeface(face);
        date.setTypeface(face);
        place.setTypeface(face);
        audience.setTypeface(face);
        schoolName.setTypeface(face);
        back = (ImageView) findViewById(R.id.img_back);
        //Utils.showToast(getApplicationContext(),startDate);
    ...
    private void initData1()
    {
        ...
        if(teacherEventListArray!= null)
            try {
                title.setText(teacherEventListArray.getJSONObject(position).getString("program_name"));
                date.setText(startDate);
                place.setText(teacherEventListArray.getJSONObject(position).getString("place"));
                audience.setText(teacherEventListArray.getJSONObject(position).getString("group_name"));

               // Glide.with(EventSharingScreen.this).load(AppConstants.SERVER_URLS.IMAGE_URL+teacherEventListArray.getJSONObject(position).getString("random_image")).crossFade().placeholder(R.drawable.eventimage).error(R.drawable.eventimage).into(schoofiLogo);
    ...
    private void initData()
    {
        ...
        if(studentEventListArray!= null)
            try {
                        title.setText(studentEventListArray.getJSONObject(position).getString("program_name"));
                         date.setText(startDate);
                place.setText(studentEventListArray.getJSONObject(position).getString("place"));
                audience.setText(studentEventListArray.getJSONObject(position).getString("group_name"));

                   // Glide.with(EventSharingScreen.this).load(AppConstants.SERVER_URLS.IMAGE_URL+studentEventListArray.getJSONObject(position).getString("random_image")).crossFade().placeholder(R.drawable.eventimage).error(R.drawable.eventimage).into(schoofiLogo);
                ...
                try
                {
                    ...
                    if(responseObject.has("school"))
                    {
                        ...
                        if(null!=schoolNotificationListArray && schoolNotificationListArray.length()>=0)
                        {
                            ...
                            Glide.with(EventSharingScreen.this).load(AppConstants.SERVER_URLS.IMAGE_URL+schoolNotificationListArray.getJSONObject(0).getString("school_logo")).crossFade().placeholder(R.drawable.imagenotavailble).error(R.drawable.imagenotavailble).into(schoolLogo);
