...
public class SchoolPlannerEditScreen extends AppCompatActivity {
    ...
    String date2="";
    String date56="";
    String title1,location1,description,startDate,endDate,plannerId,isAllday,isHoliday,classList,sectionId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set screen name.
        t.setScreenName("School Planner Edit Screen");
       ...
       if(isAllday.matches("") || isAllday.matches("null") || isAllday.matches("no"))
        {
        ...
        if(isHoliday.matches("") || isHoliday.matches("null") || isHoliday.matches("no"))
        {
       ...
       // Utils.showToast(getApplicationContext(),isAllday);
        ...
        textViewFrom.setText(date11);
        textViewTo.setText(date12);
        ...
        addClass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SchoolPlannerEditScreen.this,SchoolPlannerClassSectionListEdit.class);
                intent.putExtra("array",sectionId);
            ...
            public void onClick(View view) {
                ...
                if(sectionArray!= null)
                {
                    ...
                    if(textViewFrom.getText().toString().matches("") || textViewTo.getText().toString().matches("") || textViewFrom.getText().toString().matches("null") || textViewTo.getText().toString().matches("null"))
                    {
                        ...
                        String dat34="";
                        String dat35="";
                        dat34 = formatter1.format(date3);
                        dat35 = formatter1.format(date4);
    ...
    protected void postAttendance()
    {
        ...
        final String url1 = AppConstants.SERVER_URLS.SERVER_URL + AppConstants.SERVER_URLS.EDIT_PLANNER_EVENT/*+"?Students="+"{"+"\"Students\""+":"+teacherAttendanceDetailsListViewAdapter.teacherStudentAttendanceArray1.toString()+"}"*/;
            ...
            public void onResponse(String response) {
                ...
                try
                {
                    ...
                    if(responseObject.has("Msg")&&responseObject.getString("Msg").equals("1"))
                    {
                        ...
                        Intent intent = new Intent(SchoolPlannerEditScreen.this,SchoolPlannerMakingFirstScreen.class);
        ...
        })
        {
            ...
            protected Map<String,String> getParams(){
                ...
                Log.d("kk",date2);
                params.put("to_date_time",date56);
                params.put("type","");
                params.put("name","");
